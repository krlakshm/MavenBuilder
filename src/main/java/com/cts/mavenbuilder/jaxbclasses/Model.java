...
public class Model {
    ...
    public static class Properties {
    	...
    	protected String pbse;

       	@XmlElement(name = "project.reporting.outputEncoding", required = true)
    	protected String proe;
        
        /**
		 * @return the pbse
		 */
		public String getPbse() {
			return pbse;
		}
		/**
		 * @param pbse the pbse to set
		 */
		public void setPbse(String pbse) {
			this.pbse = pbse;
		}
		/**
		 * @return the proe
		...
		/**
		 * @param proe the proe to set
		 */
		public void setProe(String proe) {
			this.proe = proe;
		}
		@XmlElement(name = "java.version", required = true)
		...
		@XmlElement(name = "cxf.version", required = true)
        protected String cxfversion;
		/**
		 * @return the cxfversion
		 */
		public String getCxfversion() {
			return cxfversion;
		}
		/**
		 * @param cxfversion the cxfversion to set
		 */
		public void setCxfversion(String cxfversion) {
			this.cxfversion = cxfversion;
		}
